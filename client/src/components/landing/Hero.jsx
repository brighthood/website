  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl z-20">
        ...
        <button className="bg-gradient-to-tr w-56 from-primary to-purple-500  text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:bg-accent transition duration-300 ">
          አሁን ይቀላቀሉ
        </button>
      </div>
    </section>
